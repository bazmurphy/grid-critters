...
chapterData.forEach((chapter) => {
  ...
  // const buttonsContainer = document.createElement("chapter-buttons-container");
  // const previousButton = document.createElement("button");
  // previousButton.className = "chapter-button-previous";
  // previousButton.textContent = "Previous";

  // const nextButton = document.createElement("button");
  // nextButton.className = "chapter-button-next";
  ...
  chapter.levelData.forEach((level) => {
    ...
    // <p class="notes"></p>
    if (level.notes) {
      const levelNotes = document.createElement("p");
      levelNotes.className = "level-notes";
      levelNotes.textContent = level.notes;
      levelContainer.appendChild(levelNotes);
    }
    ...
    const terrainOrderLabel = document.createElement("p");
    terrainOrderLabel.className = "terrain-order-label";
    terrainOrderLabel.textContent = "Order:";
    terrainOrderContainer.appendChild(terrainOrderLabel);
